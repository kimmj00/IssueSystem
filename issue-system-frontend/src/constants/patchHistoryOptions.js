...
export const infraOptions = [
  'EMS', 'ERMS', 'SMS', 'NMS', 'DBMS', 'FMS', 'IMS',
  'SYSLOG', 'TRAP', 'TMS', 'APM', 'BMS', 'STMS', 'RTMS', 'VMS',
  'OAM', 'WNMS', 'CMS', 'K8S', 'TRMS', 'NPM', 'BRMS', 'GPM', '운영관리'
];
...
// 상태 옵션
// 백엔드 PatchStatus enum 값과 동일해야 합니다.
export const statusOptions = ['OPEN', 'RESOLVED', 'CLOSED'];

// 등록 폼 초기값
// 백엔드 PatchHistoryCreateRequest에서 title, infraType, systemName, status,
