...
import { categoryOptions, infraOptions, statusOptions } from '../../constants/patchHistoryOptions';

// 신규 패치이력 등록 모달
// 기존 화면에 노출하던 등록 폼을 모달로 분리했습니다.
export default function CreatePatchHistoryModal({
  form,
  saving,
  handleChange,
  handleSubmit,
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/40 px-4">
      <div className="max-h-[90vh] w-full max-w-[900px] overflow-y-auto rounded-2xl bg-white shadow-xl">
        <div className="sticky top-0 z-10 flex items-center justify-between border-b border-slate-200 bg-white px-6 py-4">
          <div>
            <h2 className="text-xl font-semibold text-slate-900">패치이력 등록</h2>
            <p className="mt-1 text-sm text-slate-500">신규 패치이력을 등록합니다.</p>
          </div>
